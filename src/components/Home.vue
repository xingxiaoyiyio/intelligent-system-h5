...
export default {
  ...
  data(){
      return {
         imgList: [],
         recomendList:[
             {url:'http://pic25.photophoto.cn/20121128/0042040254149743_b.jpg',name:'红烧排骨'},
             {url:'http://pic25.photophoto.cn/20121128/0042040254149743_b.jpg',name:'海鲜饭'},
             {url:'http://pic25.photophoto.cn/20121128/0042040254149743_b.jpg',name:'奶油盖浇饭'}
         ],
         newsList:[
             {title:'bgy机器人广州分店开业了'},
         ...
         shareList:[
              ...
              title:'红烧排骨',
              dec:'机器人餐厅体验太棒了~，吃得非常愉快，最喜欢可爱的迎宾小智了看就看健康健康就',
  ...
  computed:{
      swipboxWidth(){
          const  width=this.recomendList.length * 148 > window.innerWidth - 30 ? this.recomendList.length * 150 : window.innerWidth - 30
           return width+'px'
    }
  },
   methods:{
